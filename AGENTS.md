...
Last updated checkpoint: May 9, 2026.
...
Expected proof points: Preview shows Sunset Grill, four menu items, San Jose, and corrected hours. Review & Export shows Owner Review `3/3`, and JSON shows 4 menu items with 6 SEO terms.
...
10. Review Preview, then open Review & Export only if needed.
...
- The golden path is Talk -> Build corrections -> Generate Restaurant Website -> Preview.
...
- Next best polish target is a final judge-facing copy and visual-density pass across Talk, Build, and Preview.
